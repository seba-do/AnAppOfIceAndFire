...
val house7 = HouseDatabase(
    ...
    diedOut = "",
    ancestralWeapons = listOf(""),
    cadetBranches = listOf("https://www.anapioficeandfire.com/api/houses/6"),
    swornMembers = listOf(
...
val house8 = HouseDatabase(
    ...
    titles = listOf("Lord of Ashford"),
    seats = listOf("Ashford"),
    currentLord = "",
    heir = "",
    overlord = "https://www.anapioficeandfire.com/api/houses/398",
    founded = "",
...
val house10 = HouseDatabase(
    ...
    words = "",
    titles = listOf("Lord Paramount of the Trident", "Lord of Harrenhal"),
    seats = listOf("Harrenhal"),
...
val housesMock: List<HouseDatabase> =
    listOf(
        house1,
        house2,
        house3,
